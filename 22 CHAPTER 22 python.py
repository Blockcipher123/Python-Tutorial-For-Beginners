...
def file_finder(folder_path, file_extension):
    ...
    #             files.append(file)
    # return files
    return [file for file in os.listdir(folder_path) for extensions in file_extension  if file.endswith(extensions)] # (Did Using list list comprehension (Which we have studied in earliar ch-9) )
